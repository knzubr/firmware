...
#ifdef IPADDRESS
unsigned long PROGMEM mlIpEEP = IP(IPADDRESSa1,IPADDRESSb1,IPADDRESSc1,IPADDRESSd1);
unsigned long PROGMEM mlNetmaskEEP = IP(IPMASKa1,IPMASKb1,IPMASKc1,IPMASKd1);
#else
unsigned long PROGMEM mlIpEEP = IP(192,168,2,95);
unsigned long PROGMEM mlNetmaskEEP = IP(255,255,255,0);
#endif
//unsigned long  mlIpEEP = IP(192,168,2,95);
