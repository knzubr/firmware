...
prog_char cmd_light[]       = "light";            prog_char cmd_help_light[]       = "[deviceAddr] [lightNo] [time] switch on the light";
...
prog_char cmd_ustawR[]      = "setr";             prog_char cmd_help_ustawR[]      = "[value] set resistance value";
